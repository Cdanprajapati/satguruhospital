            ...
            {stats.map((item, index) => (
              <div
                ...
                className="flex flex-col items-center justify-center w-28 h-28 rounded-full 
                 bg-white shadow-[8px_8px_15px_rgba(0,0,0,0.2),-8px_-8px_15px_rgba(255,255,255,0.8)]
                 border border-gray-200 transform hover:scale-105 transition-transform duration-300"
              >
